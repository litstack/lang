...
return [
    ...
    */
    ...
    'ipv4'     => 'دەبێت :attribute ناونیشانی IPv4 دروست بێت.',
    'ipv6'     => 'دەبێت :attribute ناونیشانی IPv6 دروست بێت.',
    'json'     => 'دەبێت :attribute دەقی JSONی دروست بێت.',
    'lt'       => [
        'numeric' => 'دەبێت :attribute کەمتر بێت لە :value.',
        'file'    => 'دەبێت :attribute کەمتر بێت لە :value کیلۆبایت.',
        'string'  => 'دەبێت :attribute کەمتر بێت لە :value نوسە.',
        'array'   => 'دەبێت :attribute کەمتر بێت لە :value دانە.',
    ],
    'lte' => [
